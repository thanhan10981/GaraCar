...
export class YeuCauSuaChuaService {
  ...
  getFilteredYeuCauSuaChua(
    ...
    return this.http.get<YeuCauSuaChua[]>(`${this.apiUrl}/filter`, { params });
  }
  ...
  updateYeuCauSuaChua(id: string, yeuCau: YeuCauSuaChua): Observable<any> {
    return this.http.put(`${this.apiUrl}/${id}`, yeuCau);
  }
